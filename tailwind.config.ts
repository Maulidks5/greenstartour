    ...
    extend: {
      ...
      colors: {
        ...
        island: {
          ...
          soft: "hsl(var(--island-green-soft))",
          deep: "hsl(var(--island-green-deep))",
        },
      },
      borderRadius: {
        lg: "var(--radius)",
      ...
      animation: {
        ...
        "fade-in-up": "fade-in-up 0.9s var(--ease-luxury) both",
        "scale-in": "scale-in 0.6s var(--ease-luxury) both",
